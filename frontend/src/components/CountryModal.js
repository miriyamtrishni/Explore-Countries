        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p><span className="font-medium">Native Name:</span> {Object.values(country.name.nativeName || {})[0]?.common || country.name.common}</p>
              ...
              <p><span className="font-medium">Sub Region:</span> {country.subregion || 'N/A'}</p>
            ...
            <div>
              ...
              <p><span className="font-medium">Top Level Domain:</span> {country.tld?.join(', ') || 'N/A'}</p>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {country.borders.map(border => (
                    <span key={border} className="px-4 py-1 bg-gray-100 shadow-sm rounded-md">
                      {border}
                    </span>
                  ))}
                </div>
